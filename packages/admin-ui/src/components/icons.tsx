...
// Lightweight, dependency-free icon set. Each icon is a 20×20 stroke SVG
// designed to match the line-weight of common icon kits (Lucide / Feather)
// without pulling in a 200KB package.
